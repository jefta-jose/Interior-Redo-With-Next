    ...
    return (
        <div className="flex flex-col items-center">
            <div className='pt-3 pb-4'> 
                ...
                className='text-4xl font-bold tracking-wider text-center uppercase'>Our Categories</motion.h1>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-4 md:grid-cols-2 lg:gap-0 divide-gray-300 lg:divide-x">
                {
                    items.map((item) => (
                        ...
                        >
                            ...
                            <div className="absolute top-0 p-8 bg-white text-black bg-opacity-60 backdrop-blur m-12 rounded-sm">
